...
const KitchenDashboard = () => {
  ...
  try {
    ...
    const res = await fetch(`${API_BASE_URL}/menu/${id}/availability`, { // Matches the new Admin route
      method: 'PATCH',
      headers: { 
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}` 
      },
      body: JSON.stringify({ isAvailable: newStatus }) // Sending 'isAvailable'
    });
    ...
    alert("Sync Error: Admin privileges required.");
  }
};
